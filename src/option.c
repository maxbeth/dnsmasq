...
static const struct myoption opts[] = 
  ...
  { 
    ...
    { "log-insert-cache", 0, 0, LOPT_LOG_INS_CACHE },
...
static struct {
  ...
  { LOPT_LOG_INS_CACHE, OPT_LOG_INS_CACHE, NULL, gettext_noop("Extra logging for insert into Cache."), NULL },
